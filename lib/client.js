...
(function () {
  ...
  function makeGitBranchDock(react, h) {
    ...
    return function GitBranchDock(props) {
      ...
      var credReqInit = useState('');
      var credReq = credReqInit[0];
      var setCredReq = credReqInit[1];
      // Credentials + REQUIREMENT_ID all live in <ws>/.env.
      ...
      var loadConfig = useCallback(function () {
        ...
        Promise.all([
          ...
          var wsCred = values[2];
          // All credentials + REQUIREMENT_ID live in the workspace .env.
          ...
          setCredPass('');
          setCredReq(wsCred.requirementId || '');
          setCredInfo({
      ...
      }, [wsPath, cfgLoaded, appendLog, setBusy, setCfgName, setCfgEmail, setCfgLoaded, setCredHost, setCredUser, setCredPass, setCredReq, setCredInfo]);
      ...
      }, [wsPath, busy, credHost, credUser, credPass, credReq, appendLog, setCredHost, setCredUser, setCredPass, setCredReq, setCredInfo]);
      ...
      var tabConfig = h('div', { className: 'dshgb-form' },
        ...
        h('div', { className: 'dshgb-form-row' },
          h('input', {
            className: 'dshgb-input dshgb-input-full',
            placeholder: 'REQUIREMENT_ID（如 DREQ20250626000015）',
            value: credReq,
            disabled: busyAny,
            onChange: function (e) { setCredReq(e.target.value); },
          }),
        ),
        h('div', { className: 'dshgb-row' },
          h('button', {
          ...
          h('span', { className: 'dshgb-hint', style: { flex: 1 } },
            ...
            '；host + 账号 + 密码 + REQUIREMENT_ID 全部保存到当前工作区 .env'),
        ),
      );
